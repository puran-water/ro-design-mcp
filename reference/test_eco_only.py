#!/usr/bin/env python3
"""
Test just ECO PRO-400 simulation.
"""
...
def main():
    ...
    # Save configuration to debug
    with open('test_eco_config.json', 'w') as f:
        json.dump(formatted_config, f, indent=2)
    print(f"\n   Configuration saved to test_eco_config.json")
    ...
    try:
        ...
        print(f"   Simulation returned at: {datetime.now().strftime('%H:%M:%S')}")
